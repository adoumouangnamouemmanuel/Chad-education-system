...
const students = [
  ...
  { id: 2, name: "Fatima Ali", avatar: "/placeholder.svg?height=32&width=32" },
  {
    id: 3,
    name: "Moussa Ousmane",
    avatar: "/placeholder.svg?height=32&width=32",
  ...
  { id: 7, name: "Oumar Saleh", avatar: "/placeholder.svg?height=32&width=32" },
  {
    id: 8,
    name: "Zara Abdoulaye",
    avatar: "/placeholder.svg?height=32&width=32",
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                ...
                variant="outline"
                className={cn(
                  "w-[200px] justify-start text-left font-normal rounded-lg border-blue-200 focus:ring-blue-500",
